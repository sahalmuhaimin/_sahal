...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="<?= base_url() ?>" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light"><b> GUNA JAYA</b></span>
        </a>
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Menu Tambahan</a>
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">

                        <li><a href="<?= base_url('cek_resi') ?>" class="dropdown-item">Cek Resi</a></li>
                        <li><a href="<?= 'https://wa.me/+6281931425662' ?>" class="dropdown-item">Contact Admin</a></li>
            ...
            <li class="nav-item">
                ...
                <?php } else { ?>
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <img src="<?= base_url('assets/foto/' . $this->session->userdata('image')) ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="<?= base_url('pelanggan/wishlist/' . $this->session->userdata('id_pelanggan')) ?>" class="dropdown-item">
                            <i class="fas fa-heart mr-2"></i> Favorit Saya
                        </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <?php if (empty($keranjang)) { ?>
                        ...
                        ?>
                            <!-- Menampilkan Barang Ke Keranjang Start -->
                            <a href="#" class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-sm text-muted"><i class="fas fa-coins mr-1"></i> Rp. <?= $this->cart->format_number($value['subtotal']); ?></p>
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-divider"></div>
                        <?php } ?>
                        <!-- Menampilkan Barang Ke Keranjang End -->
                        <a href="#" class="dropdown-item">
                            <div class="media">
                                <div class="media-body">
                                    <tr>
